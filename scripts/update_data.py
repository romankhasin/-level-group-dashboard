...
def landing_host(value: object) -> str:
    """Keep the hostname only; query parameters do not define a landing variant."""
...
def update_metrika(token: str, yesterday: dt.date) -> tuple[list[dict], dict]:
    ...
    for counter_id in COUNTER_IDS:
        ...
        needs_targeting_landing_backfill = any(
            key[0] == counter_id
            and key[1] >= TARGETING_LANDING_BACKFILL_START_DATE.isoformat()
